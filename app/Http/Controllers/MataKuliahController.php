...
class MataKuliahController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = MataKuliah2::create($request->except(['_token']));
     ...
     *
     * @param  \App\Models\MataKuliah2  $mata_kuliah
     * @return \Illuminate\Http\Response
     */
    public function show(MataKuliah2 $mata_kuliah)
    {
        //
    }
    ...
    {
        $mata_kuliah = MataKuliah2::find($id);
        return view('mata_kuliah.create_mata_kuliah')
            ->with('mk', $mata_kuliah)
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = MataKuliah2::where('id', '=', $id)->update($request->except(['_token', '_method']));
        return redirect('mata_kuliah')
    ...
    {
        MataKuliah2::where('id', '=', $id)->delete();
        return redirect('mata_kuliah')
