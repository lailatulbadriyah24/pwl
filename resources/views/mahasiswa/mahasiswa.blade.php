        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-3"><b>Kelas</b></div>
                        <div class="col-1"><b>:</b></div>
                        <div class="col-8"><span id="kelas_detail"></span></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-3"><b>Nomor HP</b></div>
                        <div class="col-1"><b>:</b></div>
...
@push('custom_js')
    <script>
        ...
        $(document).ready(function() {
            var dataMahasiswa = $('#data_mahasiswa').DataTable({
                ...
                columns: [{
                    ...
                    //             "\" height=\"auto\" width=\"100px\" alt=\"foto mahasiswa\">";
                    //     }
                    // },
                    {
                        data: 'jk',
        ...
        <div class="col d-flex justify-content-center">
                                ...
                                `" data-jk="` + row.jk + `" data-tempat_lahir="` + row
                                .tempat_lahir + `" data-tanggal_lahir="` + row.tanggal_lahir +
                                `" data-alamat="` + row.alamat + `" data-kelas="` + row.kelas
                                .nama_kelas +
